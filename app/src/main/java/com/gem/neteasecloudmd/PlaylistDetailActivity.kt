...
class PlaylistDetailActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playlistName = intent.getStringExtra("playlistName") ?: "歌单"
...
fun PlaylistDetailScreen(
    ...
    var tracks by remember(refreshKey) { mutableStateOf<List<TrackItem>>(emptyList()) }
    ...
    Scaffold(
        ...
        Column(
            ...
            PullToRefreshBox(
                ...
                onRefresh = { loadTracks(showToast = true) },
